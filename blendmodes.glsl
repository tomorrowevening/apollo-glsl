...
#pragma glslify: export(BlendOpacity)
#pragma glslify: export(BlendHue)
#pragma glslify: export(BlendSaturation)
#pragma glslify: export(BlendColor)
#pragma glslify: export(BlendLuminosity)